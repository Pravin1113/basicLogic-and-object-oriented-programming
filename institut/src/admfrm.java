...
class admfrm extends JFrame implements ActionListener
{
	...
	JButton bnew,bsub,bcancel,bcle,bprint;
	JPanel top;
    ...
    JScrollPane scrlPane = new JScrollPane(tabGrid);
	   ...
	   admfrm()
		...
		bnew=new JButton("New");
	    	bnew.setBounds(30,395,90,25);
		bnew.addActionListener(this);
	    	bsub=new JButton("Submit");
	    	bsub.setBounds(150,395,90,25);
                bsub.addActionListener(this) ;
	    	bcle=new JButton("Clear");
	    	bcle.setBounds(260,395,90,25);
	    	bcle.addActionListener(this);
	    	bcancel=new JButton("ALL");
                bcancel.addActionListener(this);
	    	bcancel.setBounds(360,395,90,25);
	       	
			bprint=new JButton("Print");
                bprint.addActionListener(this);
	    	bprint.setBounds(460,395,90,25);
bprint.addActionListener(this);
