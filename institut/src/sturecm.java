...
class sturecm extends JFrame implements ActionListener
{
    ...
    JScrollPane scrlPane = new JScrollPane(tabGrid);
	  ...
	  sturecm()
		...
		bopen=new JButton("Open");
	    	bopen.setBounds(50,360,90,25);
		bopen.addActionListener(this);
	    	bmod=new JButton("Modify");
	    	bmod.setBounds(180,360,90,25);
                bmod.addActionListener(this) ;
	    	bcle=new JButton("Clear");
	    	bcle.setBounds(310,360,90,25);
	    	bcle.addActionListener(this);
	    	bcancel=new JButton("ALL");
                bcancel.addActionListener(this);
	    	bcancel.setBounds(440,360,90,25);
